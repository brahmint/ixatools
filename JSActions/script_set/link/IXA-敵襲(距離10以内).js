		...
		if (fd != null) {
			...
			if (ra != null) {
				...
				if (lname.match(/\s/) == null) {
					//http://w005.sengokuixa.jp/war/fight_history.php?type=0&find_name=&find_x=-30&find_y=-43&find_length=10&btn_exec=true
					var profURL = 'http://' + window.location.host + '/war/fight_history.php?type=0&find_name=&find_x='+x+'&find_y='+y+'&find_length=10&btn_exec=true';
