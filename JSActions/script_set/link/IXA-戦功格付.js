// IXA-戦功格付
// 2010-10-12 0.1 IXA 地図対応
jsa_IXA_RankL();

function jsa_IXA_RankL(){
			...
			if (fd != null) {
				...
				if (ra != null) {
					...
					if (lname.match(/\s/) == null) {
						var profURL = 'http://' + window.location.host + '/user/ranking.php?m=&find_rank=&find_name=' + lname + '&c='+c;
						gBrowser.loadOneTab(profURL,"utf-8",null,null,false,true);
					}
				} else {
